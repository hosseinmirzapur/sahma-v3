...
class AuthController extends Controller
{
  ...
  public function loginAction(Request $request): RedirectResponse
  {
    ...
    if (!$user || $user->deleted_at !== null || !Hash::check(strval($validated['password']), strval($user->password))) {
      throw ValidationException::withMessages(['username' => 'نام کاربری یا رمز عبور اشتباه است.']);
    }
