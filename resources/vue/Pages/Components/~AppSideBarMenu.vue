<template>
  <aside class="relative pt-5 right-0 px-5 bg-transparent">
    <div
      class="flex h-[96vh] flex-col items-start px-2 rounded-xl bg-transparent"
    >
      <!-- logo irpardaz-->
      <div class="">
        <a href="https://habibifoundation.ir" target="_blank">
          <img class="mx-auto w-24" src="/images/habibi.png" alt="logo uni" />
        </a>
      </div>
            ...
            <component
              ...
              :class="{
                '!bg-primary !text-white':
                  ...
                  $page.url.includes(item?.slug2) ||
                  $page.url.includes(item?.slug3),
              }"
      ...
      <Link :href="$route('web.user.dashboard.index')">
        ...
        >
          ...
          <path
            ...
            fill="#353DBC"
          />
          <rect x="1" y="271" width="10" height="10" fill="#353DBC" />
          <rect x="112" y="351" width="10" height="10" fill="#353DBC" />
          <path
        ...
        <p class="w-full text-sm text-center text-gray-600 my-3">نسخه 3.2</p>
      </Link>
    </div>
  </aside>
</template>
